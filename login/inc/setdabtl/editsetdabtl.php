...
if (isset($_POST['update'])){
	...
	$belanja_setda = $_POST['belanja_setda'];
    ...
    $total_sisa_anggran = $total_anggaran - $realisasi;
		...
		$query = "update tm_setda_btl set belanja_setda='$belanja_setda',tgl_program= '$tanggal',nama_kegiatan='$nama_kegiatan',total_anggaran='$total_anggaran',realisasi='$realisasi',sisa_anggaran = '$total_sisa_anggran',persen = '$total_persen' where tm_setda_btl.id_setda_btl = '$id'";
		$result = mysqli_query($link, $query);
		if ($result)
		{
			echo "<script>alert('sukses edit');window.location.assign(\"page.php?page=datasetdabtl\")</script>";

		}
		else {
			echo "<script>alert('gagal');window.location.assign(\"page.php?page=datasetdabtl\")</script>";
		}

}
else {
	$sql = "SELECT * FROM tm_setda_btl  where tm_setda_btl.id_setda_btl = '$id'";
