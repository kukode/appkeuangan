<?php
ob_start();
$queryTotal = mysqli_query($link,"SELECT SUM(total_anggaran) as jumanggaran FROM `tm_data` where tm_data.bagian = 9");
$resultTotal = mysqli_fetch_array($queryTotal);
?>

<h1 class="text-center">Bagian Progdalbang</h1>
