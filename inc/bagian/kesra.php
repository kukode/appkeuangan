<?php
ob_start();
$queryTotal = mysqli_query($link,"SELECT SUM(total_anggaran) as jumanggaran FROM `tm_data` where tm_data.bagian = 6");
$resultTotal = mysqli_fetch_array($queryTotal);
?>

<h1 class="text-center">Bagian Kesejahteraan Rakyat</h1>
