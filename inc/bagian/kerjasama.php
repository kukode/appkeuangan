<?php
ob_start();
$queryTotal = mysqli_query($link,"SELECT SUM(total_anggaran) as jumanggaran FROM `tm_data` where tm_data.bagian = 3");
$resultTotal = mysqli_fetch_array($queryTotal);

?>

<h1 class="text-center">Bagian Kerjasama</h1>
